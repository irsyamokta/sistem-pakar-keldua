...
<body>
    <div class="kiri">
        ...
        <div class="sidebar-heading">
            <h5 class="font-weight-bold text-white text-uppercase teks">Jenis Latihan</h5>
        </div>
        <section class="isi">
                    ...
                    <div class="card-body">
                        <form method="post" encytpe="multipart/form-data">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <a href="tambahGejala.php" class="btn btn-primary my-2 px-2">Tambah Bagian Tubuh</a>
                            </table>
                        </form>
                    </div>
                </div>
