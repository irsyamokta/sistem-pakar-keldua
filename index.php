...
<body>
    ...
    <div class="container-xl">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item align-self-center active">
            <a class="nav-link" href="#alur">Alur Analisis <span class="sr-only">(current)</span></a>
          </li>
    ...
    <div class="container-xl">
      <div class="row position-relative">
        <div class="col align-self-center">
          ...
          <h6 class="font-weight-normal">Analisis dan Identifikasi Olahraga Menggunakan Metode Forward Chaining</h6>
          </p>
          <a class="btn btn-primary" href="register.php" role="button">Analisis Sekarang</a>
        </div>
  ...
  <section id="alur" class="py-5 ">
    <!--Content2-->
    <div class="container-xl">
      <h1 style=" text-align: center;" class="font-weight-normal sub-heading ">Cari Tahu Olahraga dan Cara mengatasinya</h1>
      <p class="pb-5 text-center font-weight-light">Ikuti pentujuk dibawah ini, agar anda tidak kesulitan dalam menentuka Olahraga yang tepat</p>
      <p></p>
      <div class="card-deck text-center ">
        ...
        <div class="card border">
          ...
          <div class="card-body pt-5">
            <h5 class="card-title">Pilih bagian tubuh yang ingin di bentuk</h5>
            <p class="card-text font-weight-light">Dalam tahap ini pengguna akan diberikan beberapa pertanyaan terkait dengan bagian tubuh mana yang ingin di bentuk.</p>
          </div>
        </div>
        <div class="card border">
          ...
          <div class="card-body pt-5">
            ...
            <p class="card-text font-weight-light">Hasil dari kondisi fisik akan muncul dan memberikan solusi terbaik...</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-30 mb-5 container-xl">
    ...
    <div class="row mb-5">
      ...
      <div class="col-7 d-flex justify-content-center flex-column">
        <h2 class="mt-4 ">Metode Forward Chaining pada Sistem Pakar Penentuan Jenis Olahraga yang Tepat.</h2>
            ...
            <div class="card-header" id="headingTwo">
              <h2 class="mb-0">
                <button class="btn font-weight-bold btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                 Bagaimana Metode Forward Chaining bekerja dalam Sistem Pakar Rekomendasi Olahraga?
                </button>
              </h2>
            </div>
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
              Dalam sistem pakar ini, metode Forward Chaining memulai dengan data awal seperti kondisi fisik dan tujuan kebugaran, kemudian menerapkan aturan-aturan yang telah ditetapkan untuk menentukan jenis olahraga yang tepat.
              </div>
            </div>
          </div>
          <div class="card mb-3">
            <div class="card-header" id="headingThree">
              <h2 class="mb-0">
                <button class="btn font-weight-bold btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                 Mengapa Metode Forward Chaining dipilih untuk Sistem Pakar Penentuan Jenis Olahraga yang Tepat?
                </button>
              </h2>
            </div>
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
              <div class="card-body">
              Metode ini dipilih karena kemampuannya untuk menangani situasi di mana informasi awal yang tersedia adalah data fisik dan tujuan kebugaran yang mudah diamati, dan proses inferensi dapat dilakukan secara sistematis hingga mencapai rekomendasi olahraga yang tepat.
              </div>
            </div>
          </div>
          <div class="card mb-3">
    ...
    <div class=" container-xl">
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          <h5>Tentang </h5>
          <p>Sistem pakar penentuan jenis olahraga membantu individu dan pelatih kebugaran mengidentifikasi kebutuhan kebugaran, mengambil keputusan latihan, dan memberikan rekomendasi kesehatan dan kebugaran yang tepat.</p>
        </div>
        <!-- Footer Column 2 -->
        <div class="col-md-4 mb-3">
          <h5>Link </h5>
        ...
        <div class="col-md-4 mb-3">
          <h5>Kelompok 2</h5>
          <p>Wendy Hendiana Putra</p>
          <p>Aisyah Nurusy Syifa</p>
          <p>Alfat Ferdian</p>
          <p>Rida Darmayati Putri</p>
        </div>
      </div>
      <!-- Footer Bottom -->
      <div class="text-center mt-4">
        <p class="mb-0">Kelompok 2 Matkul PKB</p>
      </div>
    </div>
  </footer>
